    ...
    public partial class Журнал_Документ : Form
    {
        ...
        private void Журнал_Документ_Load(object sender, EventArgs e)
        {
            ...
            sql = "Select document.doc_id as \"Номер\", doc_name as \"Название\", doc_date as \"Дата заключения\", doc_action as \"Действие\", " +
                "doc_date_action as \"Дата действия\", sb1.subd_full_name as \"Первое подразделение\", sb2.subd_full_name as \"Второе подразделение\", place_type as \"Тип помещения\", place_area as \"Площадь\" " +
                "from document inner join subdivision as sb1 on document.subd_id1 = sb1.subd_id join subdivision as sb2 on document.subd_id2 = sb2.subd_id" +
                " inner join fixed_placement on fixed_placement.doc_id=document.doc_id " +
        ...
        private void Журнал_Документ_Activated(object sender, EventArgs e)
        {
            ...
            sql = "Select place_id as \"Код\", place_type as \"Тип помещения\", place_area as \"Площадь помещения\" from placement";
